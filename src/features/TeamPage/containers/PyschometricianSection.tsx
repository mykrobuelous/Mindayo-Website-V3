import { psychometricians } from '../data/teamData';

export default function PyschometricianSection() {
    return (
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <h2 className="mt-6 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
                        Meet our pyschometricians
                    </h2>

                    <p className="mt-4 text-base leading-8 text-slate-600 sm:text-lg">
                        Our psychometricians are trained professionals who conduct thorough
                        psychological assessments, helping clients and clinicians gain a clearer
                        picture of cognitive, emotional, and behavioral patterns.
                    </p>
                </div>
